package com.example.lunaplanner.ActualizarNota;
...
public class Actualizar_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        // Si quieres obtener el elemento en la primera posición del Spinner
        String Posicion_1 = parent.getItemAtPosition(1).toString();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (title.equals(getString(R.string.Actualizar_Nota_BD))) {
            ActualizarNotaBD();
